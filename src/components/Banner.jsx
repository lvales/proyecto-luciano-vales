   ...
   return (
      <div className="lg:px-5 bg_banner">
         <div className="lg:flex justify-between items-center">
            <img className="block lg:order-2 flex-shrink-0" src="../assets/img/banner.jpg" alt="banner" />
            <div className="relative mx-auto py-5 px-4 lg:mb-5 lg:order-1">
               <div className="lg:pb-5 lg:mb-5 text-center lg:text-start lg:flex-nowrap">
                  ...
                  <p className="text-xl xl:text-2xl font-normal text-white mt-3">Zapatillas, keds, remeras y muccho más...</p>
               </div>
            </div>
         </div>
