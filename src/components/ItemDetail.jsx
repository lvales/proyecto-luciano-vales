...
const ItemDetail = ({ item }) => {
   ...
   return (
      <>
         ...
         <div className="relative -mt-20 mb-20 p-5 mx-auto h-full w-full max-w-2xl bg-white rounded-lg shadow-md ">
            ...
            <div className="px-5 pb-5">
               ...
               <div className="flex mt-10 items-center justify-between">
                  ...
                  <span className="text-2xl font-bold text-gray-600 ">{item.stock}</span>
