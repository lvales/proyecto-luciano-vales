    ...
    return (
        ...
        <footer className="p-4 bg-white sm:p-6 dark:bg-gray-900">
                ...
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    ...
                    <div>
                        ...
                        <ul className="text-gray-600 dark:text-gray-400">
                            ...
                            <li>
                                <Link to="#" className="hover:underline">Terminos y Condiciones</Link>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <Link to="/#" className="hover:underline">.Shop</Link>. All Rights Reserved.
                </span>
                <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    ...
                    <Link to="#" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                        ...
                        <span className="sr-only">Dribbbel</span>
                    </Link>
                </div>
            </div>
        </footer>
